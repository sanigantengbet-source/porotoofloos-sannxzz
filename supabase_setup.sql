...
VALUES (
  ...
  "tldr": [
    {
      "k": "WHO",
      "v": "Founder @ SANN404 FORUM · Self-taught developer"
    },
    {
      "k": "WHAT",
      "v": "Jual source code web apps, produk digital, tools developer"
    },
    {
      "k": "WHERE",
      "v": "Indonesia · Lynk.id · WhatsApp · Telegram · TikTok"
    },
    {
      "k": "STUDY",
      "v": "Lulus SMA 2026 (jurusan IPS) · belajar teknologi otodidak"
    },
    {
      "k": "BUILD",
      "v": "Saluran komunitas 100 → 5K+ member dalam < 6 bulan"
    }
  ],
  "topSkills": [
    "TypeScript",
  ...
  "security": {
    "adminPassword": "admin",
    "updatedAt": "2026-09-14T13:38:54.691Z"
  }
}'::jsonb,
  now()
)
